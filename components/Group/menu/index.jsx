      ...
      <div className="section-filters-bar-actions">
        ...
        <div className="view-actions">
          ...
          <div className="view-action text-tooltip-tft-medium active" data-title="Big Grid" style={{'position': 'relative'}}>
            ...
            {/* /VIEW ACTION ICON */}
          <div className="xm-tooltip" style={{'white-space': 'nowrap', 'position': 'absolute', 'z-index': '99999', 'top': '-32px', 'left': '50%', 'margin-left': '-31.5px', 'opacity': '0', 'visibility': 'hidden', 'transform': 'translate(0px, 10px)', 'transition': '0.3s ease-in-out'}}><p className="xm-tooltip-text">Big Grid</p></div></div>
          {/* /VIEW ACTION */}
          ...
          <div className="view-action text-tooltip-tft-medium" data-title="Small Grid" style={{'position': 'relative'}}>
            ...
            {/* /VIEW ACTION ICON */}
          <div className="xm-tooltip" style={{'white-space': 'nowrap', 'position': 'absolute', 'z-index': '99999', 'top': '-32px', 'left': '50%', 'margin-left': '-37.5px', 'opacity': '0', 'visibility': 'hidden', 'transform': 'translate(0px, 10px)', 'transition': '0.3s ease-in-out'}}><p className="xm-tooltip-text">Small Grid</p></div></div>
          {/* /VIEW ACTION */}
          ...
          <div className="view-action text-tooltip-tft-medium" data-title="List" style={{'position': 'relative'}}>
            ...
            {/* /VIEW ACTION ICON */}
          <div className="xm-tooltip" style={{'white-space': 'nowrap', 'position': 'absolute', 'z-index': '99999', 'top': '-32px', 'left': '50%', 'margin-left': '-21px', 'opacity': '0', 'visibility': 'hidden', 'transform': 'translate(0px, 10px)', 'transition': '0.3s ease-in-out'}}><p className="xm-tooltip-text">List</p></div></div>
          {/* /VIEW ACTION */}
        </div>
        {/* /VIEW ACTIONS */}
      </div>
